<div class="main-content">
    ...
    <div class="rs-breadcrumbs breadcrumbs-overlay">
        ...
        <div class="breadcrumbs-text white-color">
            <h1 class="page-title">Familiarisation Programme for Independent Directors</h1>  
            <ul>
                <li>
                    <a class="active" href="/">Home</a>
                </li>
                <li>Familiarisation Programme for Independent Directors</li>
            </ul>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-3 col-6 mb-3">
                   <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Code of Conduct of BOD and Senior Management Personnel</h5>
                        <p class="card-text">
