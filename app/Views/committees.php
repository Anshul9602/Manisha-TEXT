...
<style>
    ...
    <div class="container mb-5">
        <h2 class="mt-5 mb-4" style="font-weight: bold;">COMPOSITION OF COMMITTEES OF BOARD</h2>
        <div class="mb-4">
            <h4><strong>A. Audit Committee</strong></h4>
            <div class="table-responsive">
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <tr>
                            <td>Yogendra Kumar Singhal</td>
                            <td>Chairman</td>
                            <td>Non-Executive - Independent Director</td>
                        </tr>
                        <tr>
                            <td>Kamta Nath Pandey</td>
                            <td>Member</td>
                            <td>Non-Executive - Independent Director</td>
                        </tr>
                        <tr>
        ...
        <div class="mb-4">
            <h4><strong>B. Stakeholder’s Relationship Committee</strong></h4>
            <div class="table-responsive">
                <table class="table table-bordered table-striped">
                    <thead class="thead-dark">
                        <tr>
