                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-12 col-sm-12 footer-widget md-mb-50">
                            ...
                            <ul class="address-widget">
                                ...
                                <li>
                                    ...
                                    <div class="desc">
                                        <a href="mailto:manishatextiles@yahoo.com">manishatextiles@yahoo.com</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        <div class="col-lg-3 col-md-12 col-sm-12 pl-50 md-pl-15 footer-widget md-mb-50">
                            ...
                            <ul class="site-map">
                                <li><a href="#">Core Banking
                                Solution</a></li>
                                <li><a href="#">MIS Solution</a></li>
                                <li><a href="#">ERP Solution</a></li>
                                <li><a href="#">Digital Payments</a></li>
                                <li><a href="#">Agricultural Trading</a></li>
                                <li><a href="#">Post-Mortem Mgmt.</a></li>
                                <li><a href="#">End-to-End Cyber Security</a></li>
                ...
                <div class="container">                    
                    <div class="row y-middle">
                        <div class="col-lg-6 md-mb-20">
                            <div class="copyright">
                                <p>&copy; 2025 All Rights Reserved Manisha Textile. Developed By <a href="https://theodin.in/">The Odin</a></p>
                            </div>
                        </div>
