    ...
    <div id="rs-founder-message" class="rs-founder-message pt-100 pb-100 md-pt-70 md-pb-70">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <h4>Dyeing Machine H.T.H.P. (Dalal)</h4>
                ...
                <div class="col-lg-12">
                    <h4>YARN HYDROEXTRACTOR (ITLAY)</h4>
                ...
                <div class="col-lg-12">
                    <h4>D. R.F. DRYER (MONGA STRAYFIELD PVT.LTD)</h4>
