    ...
    <div class="container">
        <div class="sec-title3 text-center mb-45">
            <div class="info-meta mb-3">
                <span style="background: #F5F5F5; color: #333; font-weight: 600; padding: 8px 16px; border-radius: 20px; font-size: 14px; display: inline-block; border: 1px solid #E0E0E0;">Public Announcement</span>
            </div>
                ...
                <div class="courses-item text-center">
                    <div class="courses-grid" style="background: white; border-radius: 10px; padding: 30px 20px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
                        <div class="content-part1">
                            ...
                            <h3 class="title text-start" style="color: #1A5F7A; font-weight: 600; font-size: 20px; margin-bottom: 15px;">Public Announcement</h3>
                            <a class="read-more-text" href="<?php echo base_url('') ?>assets/pdf/Public_Announcement_Ad_Dhara.pdf" target="_blank" download="">View/Download</a>
                            </div>
