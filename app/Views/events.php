...
<style>
  ...
  <h2 class="mb-4" style="font-weight: bold;">Events & Exhibitions</h2>
  <div class="row">
    <div class="col-md-4 col-sm-6 mb-4">
      <img src="assets/events/ev1.jpeg" class="img-fluid rounded" alt="Intex, Bangladesh">
      <div class="mt-2 text-center">Intex, Bangladesh</div>
    </div>
