    ...
    <div id="rs-founder-message" class="rs-founder-message pt-100 pb-100 md-pt-70 md-pb-70">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <h4>Cedaar has capability to produce from 20s to 40s with the latest state-of-art machineries: Blow Rooms from TRUMAC equipped with Blendomate, Vision Shield:</h4>
                    <ul>
                        <li>• Mixing of mélange is prepared very tuft blender from Truszler</li>
                        <li>• Blow room from Truszler/LMW</li>
                        <li>• Carding from Truszler/LMW</li>
                        <li>• Draw frame of LMW</li>
                        <li>• Efficient Combers from LMW</li>
                    </ul>
                </div>
